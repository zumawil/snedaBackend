...
from .views import ShippingStatusView, TrackShippingView, ShippingListView, ShippingDetailView
urlpatterns = [
    ...
    path('shipping-detail/<int:shipping_id>/', ShippingDetailView.as_view(), name='shipping_detail'),
]